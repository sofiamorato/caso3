public class ClientesEmisores extends Thread {
    ...
    public void run() {
        ...
        System.out.println("Cliente " + idCliente + " envio mensaje de inicio al Buzon de Entrada: " + inicio);
        ...
        for (int i = 0; i < cantidadMensajes; i++) {
            ...
            System.out.println("Cliente " + idCliente + " envio mensaje normal al Buzon de Entrada: "+ normal);
        }

        Mensaje fin = Mensaje.fin(idCliente);
        buzon.enviarMensaje(fin);
        System.out.println("Cliente " + idCliente + " envio mensaje de fin al Buzon de Entrada: " + fin);
